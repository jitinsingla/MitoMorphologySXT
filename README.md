...
- Label encoding must follow:
  ...
  - `5` → mitochondria
## Analysis
To run the paper experiments and generate plots, user should clone this repo and install the given environment. Then run the Jupyter notebook `MitoMorph_Analysis.ipynb` on your dataset.
